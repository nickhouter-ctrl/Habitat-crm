...
import { createQuoteFromPriceBook } from "@/app/(app)/prijzenboek/actions";
  ...
  return (
    <>
      <PageHeader
        ...
        actions={
          <LinkButton href="/prijzenboek" variant="ghost" title="Eenheidsprijzen aanpassen doe je in het Prijzenboek">
            Prijzen aanpassen
          </LinkButton>
        }
      />
