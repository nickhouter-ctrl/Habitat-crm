...
export const PORTAL_T = {
  nl: {
    ...
    weekTotalsHint: "voor je factuur — bedragen ex. btw",
    invoiced: "gefactureerd",
    toInvoice: "nog te factureren",
    weekWord: "week",
  ...
  es: {
    ...
    weekTotals: "Totales por semana",
    weekTotalsHint: "para tu factura — importes sin IVA",
    invoiced: "facturado",
  ...
  en: {
    ...
    weekTotalsHint: "for your invoice — amounts excl. VAT",
    invoiced: "invoiced",
